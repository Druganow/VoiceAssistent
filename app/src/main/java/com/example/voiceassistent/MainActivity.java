...
public class MainActivity extends AppCompatActivity {
    ...
    protected com.voiceassistent.messageView.MessageListAdapter messageListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageListAdapter = new com.voiceassistent.messageView.MessageListAdapter();
        Log.i("DB", savedInstanceState==null? "open":"not open");
        if (savedInstanceState==null){
            Log.i("DB", "creating cursor");
            Cursor cursor = database.query(DBHelper.TABLE_MESSAGES, null,
